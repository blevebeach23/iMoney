...
export default async function EditTransferPage({ params, searchParams }: Readonly<{ params: { id: string }; searchParams?: Record<string, string | string[] | undefined> }>) {
  ...
  return (
    <main className="mx-auto min-h-dvh max-w-md px-4 pb-24 pt-6">
      ...
      <TransferForm accounts={accounts} funds={funds} households={households} transfer={transfer} returnTo={safeMovementsReturnTo(searchParams?.returnTo)} />
    </main>
  );
}
